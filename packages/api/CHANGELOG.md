...
## [0.1.0](https://github.com/AdaAibaby/infra/compare/api-v0.0.1...api-v0.1.0) (2026-08-04)


### Features

* add workspace admin API foundations ([#3314](https://github.com/AdaAibaby/infra/issues/3314)) ([0f72030](https://github.com/AdaAibaby/infra/commit/0f72030b3c54927d68b700b77281f544d567e7d6))
* **api:** add admin team API key routes ([#2825](https://github.com/AdaAibaby/infra/issues/2825)) ([4a1e083](https://github.com/AdaAibaby/infra/commit/4a1e0837e5454b47aedc9c935717d30a35e17080))
* **api:** add feature flag to stop accepting E2B access tokens ([#3240](https://github.com/AdaAibaby/infra/issues/3240)) ([2cf489b](https://github.com/AdaAibaby/infra/commit/2cf489bd8b63f6b2848fe6e9da7c4718d8651966))
* **api:** add sandbox fork endpoint ([#3202](https://github.com/AdaAibaby/infra/issues/3202)) ([643d726](https://github.com/AdaAibaby/infra/commit/643d726f0ff4f3fd8ac0c1592812ffa88e62e2d3))
* **api:** add sandbox IAM workload token configuration ([13ddb3d](https://github.com/AdaAibaby/infra/commit/13ddb3dedc992dbb2683b086cf85a5bbbd7f9720))
* **api:** add sandbox workload identity permission ([#3319](https://github.com/AdaAibaby/infra/issues/3319)) ([13ddb3d](https://github.com/AdaAibaby/infra/commit/13ddb3dedc992dbb2683b086cf85a5bbbd7f9720))
* **api:** add user agent integration attribution to PostHog events ([#3303](https://github.com/AdaAibaby/infra/issues/3303)) ([d83be18](https://github.com/AdaAibaby/infra/commit/d83be180bb0f187dfdbc5a570f30f23be0c23895))
* **api:** discover orchestrators via nomad service ([#3176](https://github.com/AdaAibaby/infra/issues/3176)) ([32af250](https://github.com/AdaAibaby/infra/commit/32af250ca3171b2923c292c41fe7be995d297a8d))
* **api:** e2b access token deprecation feature flag rename ([#3110](https://github.com/AdaAibaby/infra/issues/3110)) ([ebc2daa](https://github.com/AdaAibaby/infra/commit/ebc2daa314af931998a1c1d0b44811467e8ccc49))
* **api:** enforce blocked-team restrictions at mutating API endpoints ([#2659](https://github.com/AdaAibaby/infra/issues/2659)) ([db848ab](https://github.com/AdaAibaby/infra/commit/db848ab73917ca763307bddde44dbf451dc45470))
* **api:** filter snapshots by name ([#3184](https://github.com/AdaAibaby/infra/issues/3184)) ([6fa1bc7](https://github.com/AdaAibaby/infra/commit/6fa1bc76b8cb2dc5a8606d2eca4e35cf9e8a133e))
* **api:** gate access token issuance behind feature flag ([#3101](https://github.com/AdaAibaby/infra/issues/3101)) ([2f7811e](https://github.com/AdaAibaby/infra/commit/2f7811e902ea2765d4fbc0d5255ab106571358ed))
* **api:** LD-gated ClickHouse read switcher ([#3061](https://github.com/AdaAibaby/infra/issues/3061)) ([29e74ca](https://github.com/AdaAibaby/infra/commit/29e74ca75aba785dedc5252957c750fa293fb036))
* **api:** limit template build name to 128 characters ([#3109](https://github.com/AdaAibaby/infra/issues/3109)) ([84aa186](https://github.com/AdaAibaby/infra/commit/84aa186bd28616a524b7cece74bb1a7dc9b7e052))
* **api:** paginated GET /v2/templates (EN-603) ([#3059](https://github.com/AdaAibaby/infra/issues/3059)) ([91e02e4](https://github.com/AdaAibaby/infra/commit/91e02e48aa350af7df1d70d59ce0a433c9fc6839))
* **api:** per-region volume type defaults from node-derived region ([#3435](https://github.com/AdaAibaby/infra/issues/3435)) ([1bded44](https://github.com/AdaAibaby/infra/commit/1bded4421e54d02e775e27d1c08ffc59bbf61d6d))
* **api:** pin resume retries to the node a previous resume timed out on ([#3066](https://github.com/AdaAibaby/infra/issues/3066)) ([a4fd0f2](https://github.com/AdaAibaby/infra/commit/a4fd0f2e5ec419fa44b78e56e6737e7cec74f6d0))
* **api:** return BYOC cluster domain from volume endpoints ([#3490](https://github.com/AdaAibaby/infra/issues/3490)) ([bb04d1f](https://github.com/AdaAibaby/infra/commit/bb04d1fc944dab666f4c6a007ea85dbfcecb6fd3))
* **api:** SOCKS5 egress proxy on sandbox network config (BYOP) ([#2642](https://github.com/AdaAibaby/infra/issues/2642)) ([1fc3820](https://github.com/AdaAibaby/infra/commit/1fc3820d7319ee2bef18c1a66bfa8294b8dc053b))
* **api:** soft-delete build layers in DB on user delete ([#3121](https://github.com/AdaAibaby/infra/issues/3121)) ([ee88776](https://github.com/AdaAibaby/infra/commit/ee887768cf28e657f36aa7038495fad37859c144))
* **auth:** support admin token team auth ([#2934](https://github.com/AdaAibaby/infra/issues/2934)) ([5496666](https://github.com/AdaAibaby/infra/commit/549666684dedf3ce3418b2c1a58f0487cadb00ff))
* dynamic sandbox log routing and ClickHouse-backed log reads ([#3236](https://github.com/AdaAibaby/infra/issues/3236)) ([1b19a3b](https://github.com/AdaAibaby/infra/commit/1b19a3bcb37d1fb44171ae8dee3a126cf3d39c34))
* **observability:** add kill_reason to sandbox.lifecycle.killed ([#2833](https://github.com/AdaAibaby/infra/issues/2833)) ([e45418f](https://github.com/AdaAibaby/infra/commit/e45418fd59eafa0aba1f34b34eae83723730bb6c))
* **observability:** include kill_reason in kill-path structured logs ([#2846](https://github.com/AdaAibaby/infra/issues/2846)) ([33c49f7](https://github.com/AdaAibaby/infra/commit/33c49f725fc8e9d0feba16a55987461c09de9680))
* **orchestrator:** add dummy orchestrator binary for local API dev ([#2744](https://github.com/AdaAibaby/infra/issues/2744)) ([ab56e25](https://github.com/AdaAibaby/infra/commit/ab56e25437d479af1b8c683afca859bad6543987))
* **orchestrator:** report hugepage metrics to API ([#3182](https://github.com/AdaAibaby/infra/issues/3182)) ([7735bae](https://github.com/AdaAibaby/infra/commit/7735bae35bd3cd3251a929e13fa9adf2333fd1e8))
* **orchestrator:** track and report last status change timestamp ([#2980](https://github.com/AdaAibaby/infra/issues/2980)) ([f79be77](https://github.com/AdaAibaby/infra/commit/f79be779ecbc1c38add07664ffbbe154bf7755b5))
* per-team events TTL limit (tier + addons) ([#3181](https://github.com/AdaAibaby/infra/issues/3181)) ([f76b2cb](https://github.com/AdaAibaby/infra/commit/f76b2cb622efde2e4958caa8358dfc95ba0b4ce7))
* **storage:** stamp provenance custom metadata on uploaded objects (incl. headers) ([#3033](https://github.com/AdaAibaby/infra/issues/3033)) ([ba8604e](https://github.com/AdaAibaby/infra/commit/ba8604e0621baefd61aaf1ea34bec27805c126cf))


### Bug Fixes

* added api and orch ([#3454](https://github.com/AdaAibaby/infra/issues/3454)) ([d56e0a8](https://github.com/AdaAibaby/infra/commit/d56e0a8bd53f54250fa4102bfaa7629f29d7af12))
* **api:** accept subdomain wildcards in network transform rule domains ([#3501](https://github.com/AdaAibaby/infra/issues/3501)) ([48d321b](https://github.com/AdaAibaby/infra/commit/48d321beac75626f15e65ba6ffb792d5f3b765e7))
* **api:** check template alias tags in exists endpoint ([#2916](https://github.com/AdaAibaby/infra/issues/2916)) ([9574cdf](https://github.com/AdaAibaby/infra/commit/9574cdf114f0efb0274d0d9fb3c06c26c864cbb9))
* **api:** copy auth/internal into api and dashboard-api image builds ([#3323](https://github.com/AdaAibaby/infra/issues/3323)) ([bda1fee](https://github.com/AdaAibaby/infra/commit/bda1fee3a288a26beb91a06a469dc70730386319))
* **api:** discover the local orchestrator as a template builder ([#3386](https://github.com/AdaAibaby/infra/issues/3386)) ([9ea005a](https://github.com/AdaAibaby/infra/commit/9ea005a609c0101a2eb387d7224ccd248c900516))
* **api:** expose pagination headers via CORS ([#3388](https://github.com/AdaAibaby/infra/issues/3388)) ([e832b1e](https://github.com/AdaAibaby/infra/commit/e832b1ed40f488dd1159fdece027bad004522be0))
* **api:** handle corrupted data in sandbox stop time ([#3203](https://github.com/AdaAibaby/infra/issues/3203)) ([a98a178](https://github.com/AdaAibaby/infra/commit/a98a1786c9a5428d8012256faf1b47d9561d49c5))
* **api:** include exhaustion reason in "Node exhausted" placement warning ([#3279](https://github.com/AdaAibaby/infra/issues/3279)) ([eb3797b](https://github.com/AdaAibaby/infra/commit/eb3797bfacb03574df534756b1a8aae63af2c4cf))
* **api:** invalidate auth cache on API key deletion ([#3324](https://github.com/AdaAibaby/infra/issues/3324)) ([8b02910](https://github.com/AdaAibaby/infra/commit/8b029108271d21273fab388146b9fe6b9fc547e8))
* **api:** let the analytics collector address carry a port ([#3394](https://github.com/AdaAibaby/infra/issues/3394)) ([6d41cb5](https://github.com/AdaAibaby/infra/commit/6d41cb594af2dfe989b3fc952bdf805f8c859c6c))
* **api:** parse the pause body regardless of Content-Length ([#3056](https://github.com/AdaAibaby/infra/issues/3056)) ([d66aab8](https://github.com/AdaAibaby/infra/commit/d66aab8c92ff4c6478d00ae82ada5048597ea391))
* **api:** prevent uint64 underflow in node allocated metrics ([#3216](https://github.com/AdaAibaby/infra/issues/3216)) ([fed38e1](https://github.com/AdaAibaby/infra/commit/fed38e11654f60aff527a9e2da661da9d11e4f4f))
* **api:** push api and db-migrator images to both latest and commit S… ([#2951](https://github.com/AdaAibaby/infra/issues/2951)) ([6f010fc](https://github.com/AdaAibaby/infra/commit/6f010fceb60987859de0d58e4bf33b81729fecbe))
* **api:** reject non-positive timeout on sandbox create, resume, and fork ([#3419](https://github.com/AdaAibaby/infra/issues/3419)) ([5a4b631](https://github.com/AdaAibaby/infra/commit/5a4b6318d42a191847a4bea39fae2a102e10851b))
* **api:** report invalid tag errors as bad requests ([#2799](https://github.com/AdaAibaby/infra/issues/2799)) ([10085a1](https://github.com/AdaAibaby/infra/commit/10085a15d83e05485d3871b1a7077931451ad98d))
* **api:** stop evicting the local node during sync ([#2881](https://github.com/AdaAibaby/infra/issues/2881)) ([5455905](https://github.com/AdaAibaby/infra/commit/545590525f327d92823bc0b4ea9d4e54d382a77e))
* **api:** use correct error variable in processCustomErrors ([#3135](https://github.com/AdaAibaby/infra/issues/3135)) ([a131a00](https://github.com/AdaAibaby/infra/commit/a131a00507f58e7f3bda3f2196162ab4435ed40f))
* correct 3 CVES ([#3218](https://github.com/AdaAibaby/infra/issues/3218)) ([076823b](https://github.com/AdaAibaby/infra/commit/076823bc5cbffb9f8c04670c886562445e50ead7))
* **orchestrator:** reject standby while draining ([#3325](https://github.com/AdaAibaby/infra/issues/3325)) ([475a7ee](https://github.com/AdaAibaby/infra/commit/475a7eee7c94f35a834b1978b189b75890c2bbe7))
* Support snapshots for non-default clusters ([#2947](https://github.com/AdaAibaby/infra/issues/2947)) ([28eeb72](https://github.com/AdaAibaby/infra/commit/28eeb72242fdd685c8a474744e6c39f1c36c34f9))


### Performance Improvements

* **api:** wake reservation waiters via pub/sub instead of 20ms polling [ENG-4070] ([#2729](https://github.com/AdaAibaby/infra/issues/2729)) ([2944d06](https://github.com/AdaAibaby/infra/commit/2944d061447fe1d1db51a56319ff6c52bdd8b856))
