// Package clickhouse carries the ClickHouse schema migrations in the binary,
// so tests and tools apply the same files the migrator applies without
// reading them from a checkout.
package clickhouse
