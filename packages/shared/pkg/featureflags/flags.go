...
var (
	MaxSandboxesPerNode           = newIntFlag("max-sandboxes-per-node", 500)
	...
	EnvdInitTimeoutMilliseconds   = newIntFlag("envd-init-request-timeout-milliseconds", 90000) // Timeout for envd init request in milliseconds
