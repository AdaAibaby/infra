  ...
  group "template-manager" {
    ...
    task "start" {
      ...
      env {
        ...
        AWS_ACCESS_KEY_ID       = "AKLTOWU2NjIzNzA2MTRhNDZhMThhYjNhMTEzMzljODdhY2Y"
        AWS_SECRET_ACCESS_KEY   = "TWpGak9EbG1ZakJoTVRNMU5HWm1NamszTVRCa05URXdPR1ZpWm1Zd01qSQ=="
        ...
        PERSISTENT_VOLUME_MOUNTS = "local:/data1/orchestrator/volumes,nas:/volcano-nfs/volumes,vepfs:/volcano-vepfs/volumes"
        DOMAIN_NAME              = ""
      }
